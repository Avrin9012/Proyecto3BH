...
<?php if (isset($_SESSION['admin'])) {
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <a style="color: #F3F1F0;" href="tr/en/index.php">To english page</a>
            <a style="color: #F3F1F0;" href="tr/ru/index.php">В Русский сайт</a>
        </div>
    </header>
    <!-- Portfolio Section-->
    ...
    <a style="color:#1a252f;" class="rick" href="course/hira/hira.php">A hiragana test</p>
    <div>
</body>
</html>