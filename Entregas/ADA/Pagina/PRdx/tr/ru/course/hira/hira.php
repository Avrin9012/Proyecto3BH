...
<form enctype="multipart/form-data" class="registrarse" action="php/action.php" autocomplete="off" method="POST">
    <div class="contenedor">
        ...
        <div>
            ...
            <p><input class="form-control" name="Answer" type="text" required placeholder="Введите свой ответ"> </p>
            <a> <input class="btn btn-primary" type="submit" name="enviar" value="Проверять" /></a>
        </div>
    </div>
</form>
