...
<center><form action="watchcards.php">
    <input class="btn btn-primary btn-xl" type="submit" value="В флашкардс"/>
</form><center>
<!-- Button to flashcards-->
<center>
<form action="delcards.php">
    <input class="btn btn-primary btn-xl" type="submit" value="Удалить флашкардс"/>
</form><center>
...
<form action="course/fb.php">
    <input class="btn btn-primary btn-xl" type="submit" value="Перейти к основным дидактическим карточкам"/>
</form><center>

<center><form action="course/fm.php">
    <input class="btn btn-primary btn-xl" type="submit" value="Перейти к средним карточкам"/>
</form><center>

<form action="course/fa.php">
    <input class="btn btn-primary btn-xl" type="submit" value="К расширенным карточкам"/>
</form><center>
