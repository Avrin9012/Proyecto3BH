                    ...
                    <div class="contenedor">
                        <h1 class="login">Регистр</h1>
                            <div>
                                ...
                                <a href="login.html"> <input class="btn btn-primary" type="submit" name="enviar" value="Подавать" /></a>
                                <input class="btn btn-primary" type="reset" name="restablecer" value="Отдыхать" /></p>
                            </div>
            <p class="IS">Вы принимаете наши <a style="color: #F3F1F0;" href="politicas.php"> условия.</a></p>
        </div>
    </form>
